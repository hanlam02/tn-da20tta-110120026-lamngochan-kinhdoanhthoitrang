                                            ...
                                            <tr>
                                                <th class="crancy-table__column-1 crancy-table__h1">
                                                    <div class="crancy-wc__checkbox" style="display: none">
                                                        <input class="crancy-wc__form-check" id="checkbox" name="checkbox" type="checkbox" style="display: none"/>
                                                        <span>Mã</span>
                                                    </div>
                                                </th>
                                        ...
                                        <tbody>
                                            @foreach ($bienthe as $item)
                                                <tr>
                                                    <td>
                                                        <div class="crancy-wc__checkbox" style="display: none">
                                                            <input class="crancy-wc__form-check" type="checkbox" name="checkbox[]" value="{{ $item->sanPham->ma_san_pham }}"  style="margin-left:20px;"/>
                                                    ...
                                                    <td>
                                                        @if($item->sanPham->hinhAnhs->first())
                                                            <img src="{{ asset('storage/images/' . $item->sanPham->hinhAnhs->first()->duong_dan) }}"  alt="{{ $item->sanPham->ten_san_pham }}" style="width: 50px; height: 50px;" />
                                                        @else
                                                            No Image
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('edit.product', ['ma_san_pham' => $item->ma_san_pham, 'ma_bien_the' => $item->ma_bien_the]) }}" class="btn btn-sm btn-warning">Sửa</a>
